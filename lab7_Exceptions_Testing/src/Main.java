...
public class Main {
    ...
    public static Cat CAT_A = new Cat("Dog", 3);
    public static Cat CAT_B = new Cat("Emperior Cornelius Big Bootyius Maximus" +
            "Jeremy Jone Jaspers WeeeWooo Supreme Lord Slap that big arse yee haw haws" +
            "lelellelellelelellelelelelellelelelelelelelelelelelellelelelelelelelelelelel" +
            "Reeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", 4);
    public static Cat CAT_C = new Cat(null, -4);
