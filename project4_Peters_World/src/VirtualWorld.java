...
public final class VirtualWorld extends PApplet {
    ...
    // "world" widths
    // original: 512 , columns(x span) 0-15
    // full: 1024 , columns(x span) 0-31
    // "newWorld": 640, columns(x span) 0-19
    public static final int VIEW_HEIGHT = 384;
    // "world" heights
    // original: 288 , rows(y span) 0-8
    // full: 576 , rows(y span) 0-17
    // "newWorld": 384 , rows(y span) 0-11
    public static final int VIEW_SCALE = 2;
    // "world" recommended scales
    // original: 2
    // full: 1
    // "newWorld": 2
    ...
    public String worldString = "newWorldDraft";
    // "world" or "newWorld"
    ...
    public static final String musicFileName = "Kane_Theme.mp3";
    ...
    public void scheduleActions(World world, EventScheduler scheduler, ImageLibrary imageLibrary) {
        for (Entity entity : world.getEntities()) {
            if (entity instanceof Behaveables behaveable) {
                behaveable.scheduleActions(scheduler, world, imageLibrary);
            }
        }
    }
    ...
    public void mousePressed() {
        ...
        if (entityOptional.isPresent()) {
            ...
            Portal portal = new Portal("Gate from Hell!", pressed, imageLibrary.get(Portal.PORTAL_KEY), 3);
            world.addEntity(portal);
            portal.scheduleActions(scheduler, world, imageLibrary);
            //try {
            //    playMusic();
